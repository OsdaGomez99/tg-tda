...
@php
    ...
    $variantMap = [
        ...
        'danger'    => 'bg-red-50 text-red-600 dark:bg-red-500/15 dark:text-red-500 hover:bg-red-100 dark:hover:bg-red-500/30 ring-1 ring-inset ring-gray-300 dark:ring-gray-700',
    ];
