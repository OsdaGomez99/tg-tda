@php
    $isDarkTheme = request()->cookie('theme') === 'dark';
@endphp
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full {{ $isDarkTheme ? 'dark' : '' }}">
...
<body class="{{ $isDarkTheme ? 'dark bg-gray-900' : '' }}">
    <div>
        <div class="flex-1 transition-all duration-300 ease-in-out">
            <header x-data="{}"
                ...
                <div class="grid w-full grid-cols-[1fr_auto_1fr] items-center mx-auto max-w-(--breakpoint-2xl) px-4 py-3 md:px-6 lg:py-4">
                    <div></div>
                    <a href="/" class="justify-self-center">
                        <img src="/images/logo/logo-xl.png" alt="Logo" width="80" height="80"/>
                    </a>

                    <!-- Theme Toggle Button -->
                    <button
                        class="relative flex items-center justify-center justify-self-end text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-dark-900 h-11 w-11 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
