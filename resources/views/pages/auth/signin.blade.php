                            ...
                            <form @submit.prevent="handleLogin" x-data="loginForm()" novalidate>
                                <div class="space-y-5">
                                    ...
                                    <div x-show="successMessage" @click.away="successMessage = ''"
                                        class="rounded-lg bg-success-50 p-4 dark:bg-success-950">
                                        <div class="flex items-start gap-3">
                                            <svg class="h-5 w-5 flex-shrink-0 text-success-600 dark:text-success-400"
                                    ...
                                    <div>
                                        ...
                                        <input type="email" x-model="form.email" placeholder="info@gmail.com"
