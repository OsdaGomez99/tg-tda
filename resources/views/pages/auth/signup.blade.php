        ...
        <div class="flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    ...
                    <div>
                        <form @submit.prevent="handleRegister" x-data="registerForm" novalidate>
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" x-model="form.firstName" name="firstName"
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" x-model="form.lastName" name="lastName"
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showConfirmPassword: false }" class="relative">
                                        <input :type="showConfirmPassword ? 'text' : 'password'"
                                            x-model="form.passwordConfirmation" placeholder="Confirma tu contraseña"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        <span @click="showConfirmPassword = !showConfirmPassword"
                                            class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
                                            <svg x-show="!showConfirmPassword" class="fill-current" width="20"
                                ...
                                <!-- Error Messages -->
                                <div x-show="errors.length > 0" class="rounded-lg bg-error-50 p-4 dark:bg-error-950">
                                    <ul class="space-y-1">
                                        <template x-for="error in errors" :key="error">
                                            <li class="text-sm text-error-700 dark:text-error-300" x-text="error"></li>
                                        </template>
                                    </ul>
                                </div>
                                <!-- Checkbox -->
