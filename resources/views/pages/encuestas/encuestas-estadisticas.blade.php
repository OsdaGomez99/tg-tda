...
@section('content')
    ...
    <div id="deleteConfirmModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div class="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                ¿Está seguro de que desea eliminar este resultado? Esta acción también eliminará sus respuestas y su
                análisis (si lo tiene) y no se puede deshacer.
            </p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setupToast('warningToast', 'closeWarningToast');
        });
    </script>
@endsection
