...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de error por defecto usados por el validador. Se aplican a
    | cualquier formulario de la aplicación que use $request->validate() o
    | un FormRequest, salvo que este último defina sus propios mensajes.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes específicos por combinación "atributo.regla", útiles cuando el
    | texto genérico de arriba no encaja bien con un campo en particular.
    |
    */
    ...
    | de la aplicación, de forma que los mensajes de arriba se lean natural
    | (p. ej. "El correo electrónico es obligatorio." en vez de "El email...").
    |
    */
